...
Rectangle {
    ...
    border.color: modelData.urgency === NotificationUrgency.Critical ? notifCard.theme.urgencyCritical :
                  modelData.urgency === NotificationUrgency.Low     ? notifCard.theme.urgencyLow     : notifCard.theme.bgBorder
    border.width: 1
    clip: true
    ...
    Rectangle {
        ...
        color: notifCard.modelData.urgency === NotificationUrgency.Critical ? notifCard.theme.urgencyCritical :
               notifCard.modelData.urgency === NotificationUrgency.Low      ? notifCard.theme.urgencyLow      : notifCard.theme.urgencyNormal
    }
